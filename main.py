...
emo_song_dict={"angry":"calm","disgusted":"energetic", "fearful":"calm", "happy":"happy", "neutral":"happy", "sad":"sad", "surprised":"energetic"}
song_no=ri(1,5)

absolutepath = os.path.abspath(__file__)
fileDirectory = os.path.dirname(absolutepath)

fileDirectory = os.path.join(fileDirectory, 'data')
fileDirectory = os.path.join(fileDirectory, 'songs')
